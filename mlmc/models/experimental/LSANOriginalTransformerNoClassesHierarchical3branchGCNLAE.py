...
class LSANOriginalTransformerNoClassesHierarchical3BranchGCNLAE(TextClassificationAbstractGraph):
    """
    https://raw.githubusercontent.com/EMNLP2019LSAN/LSAN/master/attention/model.py
    """
    def __init__(self, classes, method="glove", scale="mean", representation="roberta", dropout=0.3, propagation_layers=3, d_a=200, max_len=400, n_layers=4, **kwargs):
        super(LSANOriginalTransformerNoClassesHierarchical3BranchGCNLAE, self).__init__(**kwargs)
        #My Stuff
    ...
    def create_label_dict(self, scale="mean"):
