...
class MoKimCNNRestricted(TextClassificationAbstractMultiOutput):
    """
    ...
    """
    def __init__(self, n_outputs, classes, graph, mode="transformer", representation="roberta", kernel_sizes=[3,4,5,6], filters=100, dropout=0.5, n_layers=1, max_len=200, **kwargs):
        ...
        :param kwargs: Optimizer and loss function keyword arguments, see `mlmc.models.TextclassificationAbstract`
         """
        super(MoKimCNNRestricted, self).__init__(n_outputs = n_outputs, **kwargs)
