...
tc = mlmc.models.ConceptScoresCNNAttention(
...
# history=tc.fit(train=mlmc.data.sample(data["train"], absolute=100), valid= data["valid"], batch_size=batch_size,epochs=epochs)