...
def test_threshold_scaling_mcut():

    example1 = torch.tensor([[0.9, 0.8, 0.8, 0.7, 0.3, 0.2]])
    example2 = torch.tensor([[0.85, 0.2, 0.95, 0.9, 0.8, 0.3]])
    ind1 = torch.tensor([1, 1, 1, 1, 1, 1])
    ind2 = torch.tensor([0, 0, 0, 0, 0, 0])
    ind3 = torch.tensor([0, 0, 1, 1, 1, 1])
    ind4 = torch.tensor([0, 1, 0, 0, 0, 1])
    assert torch.equal(thresholds.threshold_scaling_mcut(example1, ind1), torch.tensor([[1., 1., 1., 1., 0., 0.]]))
    assert torch.equal(thresholds.threshold_scaling_mcut(example1, ind2), torch.tensor([[1., 1., 1., 1., 0., 0.]]))
    assert torch.equal(thresholds.threshold_scaling_mcut(example1, ind3), torch.tensor([[1., 1., 1., 1., 1., 1.]]))
    assert torch.equal(thresholds.threshold_scaling_mcut(example2, ind1), torch.tensor([[1., 0., 1., 1., 1., 0.]]))
    assert torch.equal(thresholds.threshold_scaling_mcut(example2, ind2), torch.tensor([[1., 0., 1., 1., 1., 0.]]))
    assert torch.equal(thresholds.threshold_scaling_mcut(example2, ind4), torch.tensor([[1., 1., 1., 1., 1., 1.]]))
...
def test_threshold_wrapper():
    ...
    assert torch.equal(mlmc.thresholds.get(name="mcut").__call__(example4), torch.tensor([[1., 1., 1., 1., 1., 1.]]))
    assert torch.equal(mlmc.thresholds.get(name="scaling_mcut", ind=ind).__call__(example5), torch.tensor([[1., 0., 0., 1., 0., 0.]]))
