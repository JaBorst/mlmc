...
def test_LSAN_transformer():
    assertion_function(model_type=mlmc.models.LSANOriginalTransformerNoClasses, representation="google/electra-small-discriminator", n_layers=1, filters=10, kernel_sizes=[3,4])
